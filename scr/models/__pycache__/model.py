...
def make_talk_clean_model(input_shape=(128,312,1), model_name=None, learning_rate=0.001, loss='binary_crossentropy'):
    ...
    Reshape_2_out = Reshape_2(Reshape_1_out)

    # b, f, t, c = hardtanh_2_out.shape  # batch, freq, time, channel
    # Reshape_1 = layers.Reshape((t, -1)) # (b,f,t,c) -> (b,t,f,c) -> (b,t,f*c)
    # Reshape_1_out = Reshape_1(hardtanh_2_out)  # merge freq and channel

    LayNor_1 = layers.LayerNormalization()
    LayNor_1_out = LayNor_1(Reshape_2_out)
